  ...
  return (
    <div className="mb-8 flex flex-col gap-3">
      {alerts.map((alert) => (
        <div
          key={alert._id}
          className="flex flex-col items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between"
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-amber-900">{alert.name} Refill Needed</p>
