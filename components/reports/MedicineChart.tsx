  ...
  return (
    <Card className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h2 className="text-base font-bold text-gray-900">Medicine-wise Progress</h2>
      ...
      {report.medicineProgress.length === 0 ? (
        <p className="py-6 text-sm text-gray-500">Add an active medicine to see its progress here.</p>
      ) : (
          ...
          {report.medicineProgress.map((item) => (
            <div key={item.medicineId}>
              <div className="mb-1 flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-gray-900">{item.adherencePercentage}%</span>
              </div>
