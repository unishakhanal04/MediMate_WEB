    ...
    <Card className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <button
          ...
          className="rounded-lg px-3 py-1.5 text-sm font-semibold text-gray-600 transition-colors hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800"
        >
          ←
        </button>
        ...
        <div className="flex flex-col gap-2 border-t border-gray-100 pt-4 dark:border-gray-800">
          ...
          {selectedAppointments.map((appointment) => (
            <button
              ...
              className="flex items-center justify-between rounded-lg bg-gray-50 px-3 py-2 text-left text-sm transition-colors hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700"
            >
              <span className="font-medium text-gray-900 dark:text-white">{appointment.purpose}</span>
              <span className="text-gray-500 dark:text-gray-400">{appointment.appointmentTime}</span>
            </button>
          ))}
        </div>
      )}
